...
class Search_Customer_Page:
    ...
    text_capname_id = "SearchCompany"
    btn_search_id = "search-customers"

    rows_table_xpath = "//table[@id='customers-grid']/tbody/tr"
    column_table_xpath = "//table[@id='customers-grid']/tbody/tr/td"
    ...
    def enter_customer_companyname(self,company_name):
        self.driver.find_element(By.ID,self.text_capname_id).clear()
        self.driver.find_element(By.ID,self.text_capname_id).send_keys(company_name)
    ...
    def get_results_column_table(self):
    ...
    def search_customer_by_company(self,company_name):
        ...
        for r in range(1,self.get_results_table_row()+1):
            comp_name = self.driver.find_element(By.XPATH,
